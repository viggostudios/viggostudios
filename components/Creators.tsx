  ...
  const creatorsData = [
    {
      ...
      role: "Co-fundador",
      image: davidImg,
      about: "Especialista multidisciplinar em audiovisual e design, David atua na criação de soluções visuais que unem técnica, estratégia e estética. Com experiência em produção e edição de vídeo, cobertura de eventos e direção de arte, trabalha desde o planejamento visual e captação de imagens até a pós-produção, incluindo edição, colorização e finalização para diferentes plataformas. Na área de design, desenvolve identidades visuais, composições gráficas e materiais digitais com foco em clareza, impacto e consistência de marca. Com olhar atento à estética minimalista e à hierarquia visual, lidera a direção criativa da Viggo Studios, transformando ideias em projetos visuais sólidos e de alto impacto.",
